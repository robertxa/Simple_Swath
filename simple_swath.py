...
def swath(raster_path, shapefile_path, outfile, 
    ...
    if map_plot != None:
        ...
        if "map" in map_plot:
            ...
            plotmap = True
        if plotmap:
            if "scalebar" in map_plot:
                if map_plot["scalebar"] != None:
                    scalebar = map_plot["scalebar"]
                else:
                    scalebar = False
            else:
                scalebar = False
    ...
    if profile_plot != None:
        ...
        if "legendP" in profile_plot:
            if profile_plot["legendP"] != None:
                legendP = profile_plot["legendP"]
            else:
                legendP = True
        else:
            legendP = True
...
if __name__ == '__main__':
    ...
    #porfile_plot: Set options for the swath plot
